...
export default function WateringStatus({plants = [], onUpdateWatering}) {
  ...
  return (
    <div className="space-y-6 font-body">
      <div className="glass p-4 sm:p-6 rounded-2xl border border-primary-100 flex items-center gap-4 animate-fade-in shadow-sm">
        ...
        {plants.length === 0 ? (
          ...
          plants.map((plant) => (
            <div
              ...
              className="glass p-4 sm:p-5 rounded-3xl border border-neutral-100 shadow-sm hover:shadow-premium transition-all group flex flex-col md:flex-row items-center gap-4 sm:gap-6"
            >
              <div className="flex items-center gap-4 flex-1 w-full">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-[1.25rem] overflow-hidden bg-neutral-100 shrink-0 border-2 border-white shadow-sm">
                  {plant.imagemUrl ? (
                    <img
                      src={plant.imagemUrl}
                ...
                <div>
                  <h4 className="font-heading font-black text-neutral-900 tracking-tight text-base sm:text-lg mb-1">
              ...
              <button
                ...
                className="w-full md:w-auto bg-primary-500 hover:bg-primary-600 text-white font-bold py-3 px-6 sm:py-4 sm:px-8 shadow-lg shadow-primary-500/20 transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2 text-xs sm:text-sm rounded-2xl"
              >
