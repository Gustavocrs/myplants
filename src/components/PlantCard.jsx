      ...
      <div className="aspect-[4/5] relative overflow-hidden bg-gray-100">
        ...
        {onEdit && (
          <button
            ...
            className="absolute top-4 right-4 glass text-neutral-700 p-2.5 rounded-xl shadow-lg hover:bg-white hover:text-primary-600 transition-all duration-300 opacity-0 group-hover:opacity-100 z-10 translate-y-2 group-hover:translate-y-0 border border-white/50"
            title="Editar"
          >
            <svg
