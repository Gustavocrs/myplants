...
import { FiAward, FiCpu, FiDroplet, FiGrid } from "react-icons/fi";
...
const FeaturesSection = () => {
  ...
  return (
    <section
      id="features"
      className="py-16 sm:py-24 px-4 sm:px-6 bg-neutral-100 dark:bg-neutral-900 border-y border-neutral-200 dark:border-neutral-800"
    >
      <div className="mx-auto max-w-6xl">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-4xl font-bold text-white mb-4 animate-fade-in">
            Tudo o que você precisa para{" "}
            <span className="text-primary-400">florescer</span>.
          </h2>
          <p className="text-sm sm:text-base text-neutral-400 max-w-2xl mx-auto">
            Combinamos a sabedoria da natureza com a precisão da inteligência
            artificial para que você se torne o tutor que suas plantas merecem.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {features.map((f, i) => (
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-extrabold text-white mb-3 sm:mb-4">
                {f.title}
              </h3>
